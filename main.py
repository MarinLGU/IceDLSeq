...
from models.model_3 import inference


flags = tf.app.flags

flags.DEFINE_float("learning_rate", 1E-5, "leaning rate")
...
flags.DEFINE_string("specifications", "MAE_reluFC", "specification for run identification") #MSErd0.1_mmt2_0.95_relu #MSErandom_uni0.1_mmt2_0.95
...
flags.DEFINE_boolean("is_train",True, "True if training, False if testing")
...
flags.DEFINE_boolean("recover_names", False, "True if want to recover scenarios names")
